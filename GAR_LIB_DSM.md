...
| **target** | 6 | 5 |  |  | 11 | 2 |  |  |  | 8 |  |  |
| **tests** | 15 | 6 | 7 | 35 | 74 | 18 | 15 |  | 39 | 11 |  | 1 |
| **vscode** |  |  |  |  | 3 |  |  |  |  |  |  |  |
...
- 一意なfile依存edge数: 270
- 平均path長: 3.489
- import binding数による加重平均path長: 3.548
- p95 / 最大path長: 5 / 6

## 公開メンバの参照状況サマリ

- 対象module数: 115
- 公開メンバ(top-level関数/class/UPPER定数)総数: 425
- 他moduleから一度も参照されていないメンバ: 168  (詳細は `GAR_LIB_PUBLIC_API_USAGE.md` の「外部未参照」表)
